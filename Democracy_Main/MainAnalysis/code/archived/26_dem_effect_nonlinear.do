...
esttab using ols_democracy_growth_nonlinear_noweighting.tex, replace b(3) se(3) noconstant stats(N, labels("N") fmt(0)) drop(_cons) nonotes nomtitle coeflabels(democracy_vdem2000 "Democracy Index" c.democracy_vdem2000#c.democracy_vdem2000 "(Democracy Index)$^2$" c.democracy_vdem2000#c.democracy_vdem2000#c.democracy_vdem2000 "(Democracy Index)$^3$") posthead("& \multicolumn{3}{c}{Mean GDP Growth Rate in 2001-19} \\ \cline{2-4}\\[-1.8ex]")
...
esttab using ols_democracy_growth_nonlinear_gdpweighting.tex, replace b(3) se(3) noconstant stats(N, labels("N") fmt(0)) drop(_cons) nonotes nomtitle coeflabels(democracy_vdem2000 "Democracy Index" c.democracy_vdem2000#c.democracy_vdem2000 "(Democracy Index)$^2$" c.democracy_vdem2000#c.democracy_vdem2000#c.democracy_vdem2000 "(Democracy Index)$^3$") posthead("& \multicolumn{3}{c}{Mean GDP Growth Rate in 2001-19} \\ \cline{2-4}\\[-1.8ex]")
...
forvalues i = 1/2{
	...
	esttab using 2sls_democracy_growth_nonlinear_gdpweighting_panel`i'.tex, replace b(3) se(3) label noconstant stats(N, labels("N") fmt(0)) drop(_cons) nonotes nomtitle coeflabels(democracy_vdem2000 "Democracy Index" dem2 "(Democracy Index)$^2$" dem3 "(Democracy Index)$^3$") posthead("& \multicolumn{3}{c}{Mean GDP Growth Rate in 2001-19} \\ \cline{2-4}\\[-1.8ex]")
}
