...
ggplot(total, 
       aes(x = mean_dem_vdem_change_2001_2019, 
  ...
  xlab("Mean Democracy Annual Change in 2001-2019") +
...
ggsave("figure1a_change.png", width=8, height=6,bg = 'white')
...
ggplot(total, 
       aes(x = nonstd_democracy_vdem2000, 
           y = mean_dem_vdem_change_2001_2019,
           weight = total_gdp2000,
           size = total_gdp2000,
           fill = nonstd_democracy_vdem2000)) + 
  geom_point(alpha = 0.5, 
             shape=21) +
  scale_size(range = c(.1, 60), 
             name = "total_gdp") +
