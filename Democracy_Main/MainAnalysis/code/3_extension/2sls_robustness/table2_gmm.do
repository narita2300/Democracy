...
panelcombine, use(table2_panelA1.tex table2_panelA2.tex table2_panelA3.tex table2_panelA4.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''" "`: var label `:word 4 of `outcomes'''") columncount(13) save(table2_gmm_panelA.tex) cleanup
