...
global path_output /Users/richardgong/Downloads/MainAnalysis/output/tables/extensions
...
panelcombine, use(table2_miv_panelA1.tex table2_miv_panelA2.tex table2_miv_panelA3.tex table2_miv_panelA4.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''" "`: var label `:word 4 of `outcomes'''") columncount(13) save(table2_miv_panelA.tex) cleanup
