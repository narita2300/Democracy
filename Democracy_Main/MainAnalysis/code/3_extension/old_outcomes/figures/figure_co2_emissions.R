...
## (a) Average CO2 Emissions in 1981-1990
ggplot(total, 
       aes(x = democracy_vdem1980, 
           y = avg_co2_emissions_1981_1990,
  ...
  ylab("Average CO2 Emissions in 1981-1990") +
...
ggsave("figure_avg_co2_emissions_1981_1990.png", width=8, height=6)

## (b) Average CO2 Emissions in 1991-2000
ggplot(total, 
       aes(x = democracy_vdem1990, 
           y = avg_co2_emissions_1991_2000,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Average CO2 Emissions in 1991-2000") +
...
ggsave("figure_avg_co2_emissions_1991_2000.png", width=8, height=6)

## (c) Average CO2 Emissions in 2001-2010

ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = avg_co2_emissions_2001_2010,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Average CO2 Emissions in 2001-2010") +
...
ggsave("figure_avg_co2_emissions_2001_2010.png", width=8, height=6)

## (d) Average CO2 Emissions in 2011-2020
ggplot(total, 
       aes(x = democracy_vdem2010, 
           y = avg_co2_emissions_2011_2020,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Average CO2 Emissions in 2011-2020") +
...
ggsave("figure_avg_co2_emissions_2011_2020.png", width=8, height=6)

## (e) Average CO2 Emissions in 2020-2022
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") + 
  ylab("Average CO2 Emissions in 2020-2022") +
...
ggsave("figure_avg_co2_emissions_2020_2022.png", width=8, height=6)