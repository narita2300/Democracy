...
## (a) Effective Retirement Age Men in 1980
ggplot(total, 
       aes(x = democracy_vdem1980, 
           y = effective_ret_age_men_1980,
  ...
  ylab("% Change Effective Retirement Age Men in 1970-1980") +
...
ggsave("figure_effective_ret_age_men_1980.png", width=8, height=6)

## (b) Effective Retirement Age Men in 1990
ggplot(total, 
       aes(x = democracy_vdem1990, 
           y = effective_ret_age_men_1990,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("% Change Effective Retirement Age Men in 1980-1990") +
...
ggsave("figure_effective_ret_age_men_1990.png", width=8, height=6)


## (c) Effective Retirement Age Men in 2000

ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = effective_ret_age_men_2000,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("% Change Effective Retirement Age Men in 1990-2000") +
...
ggsave("figure_effective_ret_age_men_2000.png", width=8, height=6)

## (d) Effective Retirement Age Men in 2010
ggplot(total, 
       aes(x = democracy_vdem2010, 
           y = effective_ret_age_men_2010,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("% Change Effective Retirement Age Men in 2000-2010") +
...
ggsave("figure_effective_ret_age_men_2010.png", width=8, height=6)

## (e) Effective Retirement Age Men in 2020
ggplot(total, 
       aes(x = democracy_vdem2020, 
           y = effective_ret_age_men_2020,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("% Change Effective Retirement Age Men in 2010-2020") +
...
ggsave("figure_effective_ret_age_men_2020.png", width=8, height=6)