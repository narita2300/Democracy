...
# Mean Bot 50% Income Share in 2001-2019
ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = mean_bot50_inc_shr_2001_2019,
  ...
  ylab("Growth Rate Mean Bot 50% Income Share in 2001-2019") +
...
ggsave("figure_mean_bot50_inc_shr_2001_2019.png", width=8, height=6)

# Bot 50% Income Share in 2020
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = bot50_inc_shr_2020_2021,
  ...
  ylab("Growth Rate Mean Bot 50% Income Share in 2020-2021") +
...
ggsave("figure_bot50_income_share2020.png", width=8, height=6)
