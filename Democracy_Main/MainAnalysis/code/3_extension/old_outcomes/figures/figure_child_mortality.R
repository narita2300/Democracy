...
## (a) Child Mortality in 1981-1990
ggplot(total, 
       aes(x = democracy_vdem1980, 
           y = child_mortality_1981_1990,
  ...
  ylab("Children Mortality Growth %, 1981-1990") +
...
ggsave("figure_child_mortality_1981_1990.png", width=8, height=6)

## (b) Child Mortality in 1991-2000
ggplot(total, 
       aes(x = democracy_vdem1990, 
           y = child_mortality_1991_2000,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Children Mortality Growth %, 1991-2000") +
...
ggsave("figure_child_mortality_1991_2000.png", width=8, height=6)

## (c) Child Mortality in 2001-2010

ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = child_mortality_2001_2010,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Children Mortality Growth %, 2001-2010") +
...
ggsave("figure_child_mortality_2001_2010.png", width=8, height=6)

## (d) Child Mortality in 2011-2020
ggplot(total, 
       aes(x = democracy_vdem2010, 
           y = child_mortality_2011_2020,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Children Mortality Growth %, 2011-2020") +
...
ggsave("figure_child_mortality_2011_2020.png", width=8, height=6)