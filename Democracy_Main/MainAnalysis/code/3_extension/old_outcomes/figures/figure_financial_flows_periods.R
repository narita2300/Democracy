...
ggplot(total, 
  ...
  ylab("Mean Financial Flows in 1981-1990 % Change") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Financial Flows in 1991-2000 % Change") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Financial Flows in 2001-2010 % Change") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Financial Flows in 2011-2020 % Change") +
...
## (e) Mean Financial Flows in 2020-2022
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = financial_flow_2020_2022,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Financial Flows in 2020-2022 % Change") +
...
ggsave("figure_mean_financial_flows_2020_2022.png", width=8, height=6)