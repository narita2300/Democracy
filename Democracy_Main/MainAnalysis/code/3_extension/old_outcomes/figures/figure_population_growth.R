...
# Population Growth 1981-1990
ggplot(total, 
       aes(x = democracy_vdem1980, 
           y = pop_growth_1981_1990,
  ...
  ylab("Population Growth 1981-1990") +
...
ggsave("figure_population_growth_1981_1990.png", width=8, height=6)


# Population Growth 1991-2000
ggplot(total, 
       aes(x = democracy_vdem1990, 
           y = pop_growth_1991_2000,
  ...
  scale_fill_viridis(discrete=FALSE, guide=FALSE, option="A") +
  theme_ipsum(axis_title_size = 20) +
  ylab("Population Growth 1991-2000") +
...
ggsave("figure_population_growth_1991_2000.png", width=8, height=6)


# Population Growth 2001-2010
ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = pop_growth_2001_2010,
  ...
  scale_fill_viridis(discrete=FALSE, guide=FALSE, option="A") +
  theme_ipsum(axis_title_size = 20) +
  ylab("Population Growth 2001-2010") +
...
ggsave("figure_population_growth_2001_2010.png", width=8, height=6)

# Population Growth 2011-2020
ggplot(total, 
       aes(x = democracy_vdem2010, 
           y = pop_growth_2011_2020,
  ...
  scale_fill_viridis(discrete=FALSE, guide=FALSE, option="A") +
  theme_ipsum(axis_title_size = 20) +
  ylab("Population Growth 2011-2020") +
...
ggsave("figure_population_growth_2011_2020.png", width=8, height=6)
