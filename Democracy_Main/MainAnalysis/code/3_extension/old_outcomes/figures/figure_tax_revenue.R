...
## (a) Mean Tax Revenue % (Share of GDP) Growth Rate in 1981-1990
ggplot(total, 
       aes(x = democracy_vdem1980, 
           y = avg_taxshare_1981_1990,
  ...
  ylab("Mean Tax Revenue % in 1981-1990") +
...
ggsave("figure_avg_taxshare_1981_1990.png", width=8, height=6)

## (b) Mean Tax Revenue % (Share of GDP) Growth Rate in 1991-2000
ggplot(total, 
       aes(x = democracy_vdem1990, 
           y = avg_taxshare_1991_2000,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Tax Revenue % in 1991-2000") +
...
ggsave("figure_avg_taxshare_1991_2000.png", width=8, height=6)

## (c) Mean Tax Revenue % (Share of GDP) Growth Rate in 2001-2010

ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = avg_taxshare_2001_2010,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Tax Revenue % in 2001-2010") +
...
ggsave("figure_avg_taxshare_2001_2010.png", width=8, height=6)

## (d) Mean Tax Revenue % (Share of GDP) Growth Rate in 2011-2020
ggplot(total, 
       aes(x = democracy_vdem2010, 
           y = avg_taxshare_2011_2020,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Tax Revenue % in 2011-2020") +
...
ggsave("figure_avg_taxshare_2011_2020.png", width=8, height=6)

## (e) Mean Tax Revenue % (Share of GDP) Growth Rate During Covid-19
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = avg_taxshare_2020_2022,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Tax Revenue % During Covid-19") +
...
ggsave("figure_avg_taxshare_2020_2022.png", width=8, height=6)