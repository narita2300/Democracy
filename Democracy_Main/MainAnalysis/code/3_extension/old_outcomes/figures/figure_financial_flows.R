...
# Mean Financial Flows in 2001-2019
ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = mean_financial_flows_2001_2019,
  ...
  ylab("Mean Financial Flows in 2001-2019") +
...
ggsave("figure_mean_financial_flows_2001_2019.png", width=8, height=6)

# Financial Flows in 2020
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = financial_flows2020,
...
ggsave("figure_financial_flows2020.png", width=8, height=6)
