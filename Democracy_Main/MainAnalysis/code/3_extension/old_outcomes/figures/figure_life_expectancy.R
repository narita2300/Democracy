...
## (a) Life Expectancy in 1981-1990
ggplot(total, 
       aes(x = democracy_vdem1980, 
           y = life_expectancy_1981_1990,
  ...
  ylab("Life Expectancy in 1981-1990") +
...
ggsave("figure_life_expectancy_1981_1990.png", width=8, height=6)

## (b) Life Expectancy in 1991-2000
ggplot(total, 
       aes(x = democracy_vdem1990, 
           y = life_expectancy_1991_2000,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Life Expectancy in 1991-2000") +
...
ggsave("figure_life_expectancy_1991_2000.png", width=8, height=6)

## (c) Life Expectancy in 2001-2010

ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = life_expectancy_2001_2010,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Life Expectancy in 2001-2010") +
...
ggsave("figure_life_expectancy_2001_2010.png", width=8, height=6)

## (d) Life Expectancy in 2011-2020
ggplot(total, 
       aes(x = democracy_vdem2010, 
           y = life_expectancy_2011_2020,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Life Expectancy in 2011-2020") +
...
ggsave("figure_life_expectancy_2011_2020.png", width=8, height=6)

## (e) Life Expectancy During Covid-19
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = life_expectancy_2020_2022,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Life Expectancy During Covid-19") +
...
ggsave("figure_life_expectancy_2020_2022.png", width=8, height=6)