...
local count = 1
local outcomes mean_financial_flows_2001_2019 financial_flow_2020_2022
...
foreach outcome of local outcomes{
	...
	esttab using "old/table_financial_flows_panelA`count'.tex", ///
...
panelcombine, use("old/table_financial_flows_panelA1.tex" "old/table_financial_flows_panelA2.tex") paneltitles("Mean Growth Rate Financial Flow 2001-2019" "Mean Growth Rate Financial Flow 2020-2022") columncount(13) save("old/table_financial_flows_panelA.tex") cleanup
...
foreach outcome of local outcomes{
	...
	esttab using "old/table_financial_flows_panelB`count'.tex", ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use("old/table_financial_flows_panelB1.tex" "old/table_financial_flows_panelB2.tex") paneltitles("Mean Growth Rate Financial Flow 2001-2019" "Mean Growth Rate Financial Flow 2020-2022") columncount(13) save("old/table_financial_flows_panelB.tex") cleanup
