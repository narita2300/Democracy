...
local count = 1 	
local outcomes mean_death_per_million excess_deaths_20_21
...
foreach outcome of local outcomes{
	...
	esttab using "old/table_extend_deaths_panelA`count'.tex", ///
...
panelcombine, use("old/table_extend_deaths_panelA1.tex" "old/table_extend_deaths_panelA2.tex") paneltitles("Mean Covid-19 Deaths per Million 2020-2023" "Mean Excess Deaths per Million 2020-2021") columncount(13) save("old/table_extend_deaths_panelA.tex") cleanup
...
foreach outcome of local outcomes{
	...
	esttab using "old/table_extend_deaths_panelB`count'.tex", ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use("old/table_extend_deaths_panelB1.tex" "old/table_extend_deaths_panelB2.tex") paneltitles("Mean Covid-19 Deaths per Million 2020-2023" "Mean Excess Deaths per Million 2020-2021") columncount(13) save("old/table_extend_deaths_panelB.tex") cleanup
