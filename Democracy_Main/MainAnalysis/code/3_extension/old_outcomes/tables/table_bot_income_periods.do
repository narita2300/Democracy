...
drop if mean_bot50_inc_shr_1991_2000==.
drop if mean_bot50_inc_shr_2001_2010==.
drop if mean_bot50_inc_shr_2011_2020==.
...
************************************ 
************************************ Y: Mean Bot 50% Income Share in 1991-2000 

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls mean_bot50_inc_shr_1991_2000 (democracy_vdem1990=${iv`i'})[w=total_gdp1990], vce(robust)
		eststo: ivregress 2sls mean_bot50_inc_shr_1991_2000 abs_lat mean_temp_1981_1990 mean_precip_1981_1990 median_age1990 pop_density1990 (democracy_vdem1990=${iv`i'})[w=total_gdp1990], vce(robust)
	}
...
************************************ 
************************************ Y: Mean Bot 50% Income Share in 2001-2010

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls mean_bot50_inc_shr_2001_2010 (democracy_vdem2000=${iv`i'})[w=total_gdp2000], vce(robust)
		eststo: ivregress 2sls mean_bot50_inc_shr_2001_2010 abs_lat mean_temp_1991_2000 mean_precip_1991_2000 median_age2000 pop_density2000 (democracy_vdem2000=${iv`i'})[w=total_gdp2000], vce(robust)
	}
...
*********************************** 
************************************ Y: Mean Bot 50% Income Share in 2011-2020

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls mean_bot50_inc_shr_2011_2020 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
		eststo: ivregress 2sls mean_bot50_inc_shr_2011_2020 abs_lat mean_temp_2001_2010 mean_precip_2001_2010 median_age2010 pop_density2010 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
	}
...
panelcombine, use("old/2sls_by_decade_panel2.tex" "old/2sls_by_decade_panel3.tex" "old/2sls_by_decade_panel4.tex") paneltitles("Growth Rate  Mean Bot 50\% Income Share in 1991-2000" "Growth Rate Mean Bot 50\% Income Share in 2001-2010" "Growth Rate Mean Bot 50\% Income Share in 2011-2020") columncount(13) save("old/2sls_by_decade_bot50_inc_shr.tex") cleanup
