...
local outcomes mean_top1_inc_shr_2001_2019 mean_top10_inc_shr_2001_2019 top1_inc_shr_2020_2021 top10_inc_shr_2020_2021

foreach outcome of local outcomes{
	
	if "`outcome'" == "mean_top1_inc_shr_2001_2019" | "`outcome'" == "mean_top10_inc_shr_2001_2019" {
	...
	esttab using ${path_output}/old/table_top_income_panelA`count'.tex, ///
...
panelcombine, use(${path_output}/old/table_top_income_panelA1.tex ${path_output}/old/table_top_income_panelA2.tex ${path_output}/old/table_top_income_panelA3.tex ${path_output}/old/table_top_income_panelA4.tex) paneltitles("Mean Top 1\% Income Share in 2001-2019 Mean Growth Rate" "Mean Top 10\% Income Share in 2001-2019 Mean Growth Rate" "Mean Top 1\% Income Share in 2020-2021 Mean Growth Rate" "Mean Top 10\% Income Share in 2020-2021 Mean Growth Rate") columncount(13) save(${path_output}/old/table_top_income_panelA.tex) cleanup
...
foreach outcome of local outcomes{
	...
	esttab using ${path_output}/old/table_top_income_panelB`count'.tex, ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(${path_output}/old/table_top_income_panelB1.tex ${path_output}/old/table_top_income_panelB2.tex ${path_output}/old/table_top_income_panelB3.tex ${path_output}/old/table_top_income_panelB4.tex) paneltitles("Mean Top 1\% Income Share in 2001-2019 Mean Growth Rate" "Mean Top 10\% Income Share in 2001-2019 Mean Growth Rate" "Mean Top 1\% Income Share in 2020-2021 Mean Growth Rate" "Mean Top 10\% Income Share in 2020-2021 Mean Growth Rate") columncount(13) save(${path_output}/old/table_top_income_panelB.tex) cleanup
