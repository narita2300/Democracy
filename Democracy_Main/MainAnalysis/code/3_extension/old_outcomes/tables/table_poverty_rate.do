...
local count = 1
local outcomes avg_poverty_rate_after_2010
...
foreach outcome of local outcomes{
	...
	esttab using table_poverty_rate_panelA`count'.tex, ///
...
panelcombine, use(table_poverty_rate_panelA1.tex) paneltitles("Average Poverty Rate After 2010") columncount(13) save(table_poverty_rate_panelA.tex) cleanup
...
foreach outcome of local outcomes{
	...
	esttab using table_poverty_rate_panelB`count'.tex, ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(table_poverty_rate_panelB1.tex) paneltitles("Average Poverty Rate After 2010") columncount(13) save(table_poverty_rate_panelB.tex) cleanup
