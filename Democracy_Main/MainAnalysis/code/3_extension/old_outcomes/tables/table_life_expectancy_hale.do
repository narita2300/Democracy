...
drop if hale_2000_2010==.
drop if hale_2010_2019==.
...
************************************ 
************************************ Y: Life Expectancy HALE in 2000

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls hale_2000_2010 (democracy_vdem2000=${iv`i'})[w=total_gdp2000], vce(robust)
		eststo: ivregress 2sls hale_2000_2010 abs_lat mean_temp_1991_2000 mean_precip_1991_2000 median_age2000 pop_density2000 (democracy_vdem2000=${iv`i'})[w=total_gdp2000], vce(robust)
	}
