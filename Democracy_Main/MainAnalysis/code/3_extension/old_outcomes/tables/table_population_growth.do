...
drop if pop_growth_1981_1990==.
drop if pop_growth_1991_2000==.
drop if pop_growth_2001_2010==.
drop if pop_growth_2011_2020==.
...
************************************ 
************************************ Y: Population Growth Rate 1981-1990

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls pop_growth_1981_1990 (democracy_vdem1980=${iv`i'})[w=total_gdp1980], vce(robust)
		eststo: ivregress 2sls pop_growth_1981_1990 abs_lat mean_temp_1971_1980 mean_precip_1971_1980 median_age1980 pop_density1980 (democracy_vdem1980=${iv`i'})[w=total_gdp1980], vce(robust)
	}
...
************************************ 
************************************ Y: Population Growth Rate 1991-2000

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls pop_growth_1991_2000 (democracy_vdem1990=${iv`i'})[w=total_gdp1990], vce(robust)
		eststo: ivregress 2sls pop_growth_1991_2000 abs_lat mean_temp_1981_1990 mean_precip_1981_1990 median_age1990 pop_density1990 (democracy_vdem1990=${iv`i'})[w=total_gdp1990], vce(robust)
	}
...
************************************ 
************************************ Y: Population Growth Rate 2001-2010

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls pop_growth_2001_2010 (democracy_vdem2000=${iv`i'})[w=total_gdp2000], vce(robust)
		eststo: ivregress 2sls pop_growth_2001_2010 abs_lat mean_temp_1991_2000 mean_precip_1991_2000 median_age2000 pop_density2000 (democracy_vdem2000=${iv`i'})[w=total_gdp2000], vce(robust)
	}
...
************************************ 
************************************ Y: Population Growth Rate 2011-2020

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls pop_growth_2011_2020 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
		eststo: ivregress 2sls pop_growth_2011_2020 abs_lat mean_temp_2001_2010 mean_precip_2001_2010 median_age2010 pop_density2010 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
	}
...
panelcombine, use(${path_output}/2sls_by_decade_panel1.tex ${path_output}/2sls_by_decade_panel2.tex ${path_output}/2sls_by_decade_panel3.tex ${path_output}/2sls_by_decade_panel4.tex) paneltitles("Population Growth Rate 1981-1990" "Population Growth Rate 1991-2000" "Population Growth Rate 2001-2010" "Population Growth Rate 2011-2020") columncount(13) save(${path_output}/2sls_by_decade_pop_growth.tex) cleanup
