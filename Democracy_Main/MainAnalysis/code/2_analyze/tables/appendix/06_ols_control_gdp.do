...
esttab using 3_ols_control_gdp_panel1.tex, ///
keep(${dem2000}) ///
...
esttab using 3_ols_control_gdp_panel2.tex, ///
keep(${dem2019}) ///
replace label b(a1) se(a1) noobs nodepvars nogaps nonotes mlabels(none) nostar
...
eststo: reg ${outcome3} ${dem2000} ${weight2000}, vce(robust)
eststo: reg ${outcome3} ${base_covariates2000} ${dem2000} ${weight2000}, vce(robust)

**# Bookmark #1
eststo: reg ${outcome3} gdppc2000 ${dem2000} ${weight2000}, vce(robust)
eststo: reg ${outcome3} gdppc2000 ${base_covariates2000} ${dem2000} ${weight2000}, vce(robust)

eststo: reg ${outcome3} total_gdp2000 ${dem2000} ${weight2000}, vce(robust)
eststo: reg ${outcome3} total_gdp2000 ${base_covariates2000} ${dem2000} ${weight2000}, vce(robust)


eststo: reg ${outcome3} gdppc2000 total_gdp2000 ${dem2000} ${weight2000}, vce(robust)
eststo: reg ${outcome3} gdppc2000 total_gdp2000 ${base_covariates2000} ${dem2000} ${weight2000}, vce(robust)


esttab using 3_ols_control_gdp_panel3.tex, ///
keep(${dem2000}) ///
...
panelcombine, use(3_ols_control_gdp_panel1.tex 3_ols_control_gdp_panel2.tex 3_ols_control_gdp_panel3.tex) paneltitles("`: var label ${outcome1}'" "`: var label ${outcome2}'" "`: var label ${outcome3}'") columncount(9) save(3_ols_control_gdp.tex) cleanup
