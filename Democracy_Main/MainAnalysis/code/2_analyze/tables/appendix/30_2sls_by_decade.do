...
esttab using 2sls_by_decade_panel1.tex, ///
...
esttab using 2sls_by_decade_panel2.tex, ///
...
esttab using 2sls_by_decade_panel3.tex, ///
...
esttab using 2sls_by_decade_panel4.tex, ///
keep(democracy_vdem2010) ///
replace label b(a1) se(a1) noobs nostar nodepvars nogaps nonotes mlabels(none) ///

include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(2sls_by_decade_panel1.tex 2sls_by_decade_panel2.tex 2sls_by_decade_panel3.tex 2sls_by_decade_panel4.tex) paneltitles("Mean GDP Growth Rate in 1981-1990" "Mean GDP Growth Rate in 1991-2000" "Mean GDP Growth Rate in 2001-2010" "Mean GDP Growth Rate in 2011-2019") columncount(13) save(15_2sls_by_decade_panelA.tex) cleanup
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(2sls_by_decade_panel1.tex 2sls_by_decade_panel2.tex 2sls_by_decade_panel3.tex 2sls_by_decade_panel4.tex) paneltitles("Mean GDP Growth Rate in 1981-1990" "Mean GDP Growth Rate in 1991-2000" "Mean GDP Growth Rate in 2001-2010" "Mean GDP Growth Rate in 2011-2019") columncount(13) save(15_2sls_by_decade_panelB.tex) cleanup
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(2sls_by_decade_panel1.tex 2sls_by_decade_panel2.tex 2sls_by_decade_panel3.tex 2sls_by_decade_panel4.tex) paneltitles("Mean GDP Growth Rate in 1981-1990" "Mean GDP Growth Rate in 1991-2000" "Mean GDP Growth Rate in 2001-2010" "Mean GDP Growth Rate in 2011-2019") columncount(13) save(15_2sls_by_decade_panelC.tex) cleanup
