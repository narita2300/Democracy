...
esttab using 18_policy_mechanisms_panel1.tex, ///
...
panelcombine, use(18_policy_mechanisms_panel1.tex) paneltitles(" ") columncount(13) save(18_policy_mechanisms_panelA.tex) cleanup
...
esttab using 18_policy_mechanisms_panel2.tex, ///
	replace label b(a1) se(a1) noobs nostar ///
	nodepvars nogaps nonotes mlabels(none) keep(${dem2019}) ///

include "${path_code}/2_analyze/tables/PanelCombine_simplest.do"
panelcombine, use(18_policy_mechanisms_panel2.tex) paneltitles(" ") columncount(13) save(18_policy_mechanisms_panelB.tex) cleanup
...
esttab using 18_policy_mechanisms_panel3.tex, ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simplest.do"
panelcombine, use(18_policy_mechanisms_panel3.tex) paneltitles(" ") columncount(13) save(18_policy_mechanisms_panelC.tex) cleanup
