...
forv i=1/3{
	...
	esttab using monotonicity_check1.tex, nocons replace label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
esttab using monotonicity_check1.tex, nocons append label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
forv i=1/3{
	...
	esttab using motonotonicity_check2.tex, nocons replace label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
esttab using motonotonicity_check2.tex, nocons append label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
forv i=1/3{
	...
	esttab using motonotonicity_check3.tex, nocons replace label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
esttab using motonotonicity_check3.tex, nocons append label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
forv i=1/3{
	...
	esttab using motonotonicity_check4.tex, nocons replace label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
esttab using motonotonicity_check4.tex, nocons append label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
esttab using first_stage_alph1.tex, nocons replace label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
...
esttab using first_stage_alph2.tex, nocons replace label b(a1) se(a1) nostar nodepvars drop(${base_covariates2019} _cons) stats(N, labels("N")) obslast nogaps nonotes mlabels(none)
