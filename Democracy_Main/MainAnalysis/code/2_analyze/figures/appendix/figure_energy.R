...
## (a) Average Energy Consumption in 2001-2019
ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = avg_energy_2001_2019,
  ...
  ylab("Energy Consumption Growth in 2001-19") +
...
ggsave("figure_energy_2001_2019.png", width=8, height=6)

## (b) Average Energy Consumption in 2020-2022
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = avg_energy_2020_2022,
  ...
  ylab("Energy Consumption Growth in 2020-22") +
...
ggsave("figure_energy_2019_2022.png", width=8, height=6)
