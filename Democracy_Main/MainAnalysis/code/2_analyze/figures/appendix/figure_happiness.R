...
## (a) Life Ladder 2010-2019
ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = life_ladder_2010_2019,
  ...
  ylab("Life Ladder Growth in 2010-19") +
...
ggsave("figure_life_ladder_2010_2019.png", width=8, height=6)

## (b) Life Ladder 2020-2022
ggplot(total, 
  ...
  ylab("Life Ladder Growth in 2020-22") +
...
ggsave("figure_life_ladder_2020_2022.png", width=8, height=6)
