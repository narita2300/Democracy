...
## (a) Top Income Share 2001-2019
ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = top_income_share_2001_2019,
  ...
  ylab("Top Income Share Change in 2001-19") +
...
ggsave("figure_top_income_2001_2019.png", width=8, height=6)

## (b) Top Income Share 2020-2022
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = top_income_share_2020_2022,
  ...
  ylab("Top Income Share Change in 2020-22") +
...
ggsave("figure_top_income_2020_2022.png", width=8, height=6)
