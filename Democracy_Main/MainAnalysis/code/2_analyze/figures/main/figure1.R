...
ggsave("figure1a.png", width=8, height=6,bg = 'white')
...
ggsave("figure1b.png", width=8, height=6, bg = 'white')

################################################################################
## (c) Nighttime light growth 2001-2013
ggplot(total,
       aes(x = democracy_vdem2000, 
...
ggsave("figure1c.png", width=8, height=6, bg = 'white')
################################################################################
