...
local count = 1
local outcomes mean_financial_flows_2001_2019 financial_flows2020 financial_flows2021 financial_flows2021

foreach outcome of local outcomes{
	
	if "`outcome'" == "mean_financial_flows_2001_2019" {
	...
	esttab using table_financial_flows_panelA`count'.tex, ///
...
panelcombine, use(table_financial_flows_panelA1.tex table_financial_flows_panelA2.tex table_financial_flows_panelA3.tex table_financial_flows_panelA4.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table_financial_flows_panelA.tex) cleanup
...
foreach outcome of local outcomes{
	...
	esttab using table_financial_flows_panelB`count'.tex, ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(table_financial_flows_panelB1.tex table_financial_flows_panelB2.tex table_financial_flows_panelB3.tex table_financial_flows_panelB4.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table_financial_flows_panelB.tex) cleanup
