...
local outcomes mean_top1_inc_shr_2001_2019 mean_top10_inc_shr_2001_2019 top1_income_share2020 top1_income_share2021 top10_income_share2020 top10_income_share2021
...
foreach outcome of local outcomes{
	...
	esttab using table_top_income_panelA`count'.tex, ///
...
panelcombine, use(table_top_income_panelA1.tex table_top_income_panelA2.tex table_top_income_panelA3.tex table_top_income_panelA4.tex table_top_income_panelA5.tex table_top_income_panelA6.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table_top_income_panelA.tex) cleanup
...
foreach outcome of local outcomes{
	...
	esttab using table_top_income_panelB`count'.tex, ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(table_top_income_panelB1.tex table_top_income_panelB2.tex table_top_income_panelB3.tex table_top_income_panelB4.tex table_top_income_panelB5.tex table_top_income_panelB6.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table_top_income_panelB.tex) cleanup
