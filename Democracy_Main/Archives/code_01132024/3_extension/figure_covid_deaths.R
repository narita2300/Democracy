...
# Covid-19-related Deaths Per Million in 2021
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = total_deaths_per_million21,
  ...
  ylab("Covid-19-related Deaths Per Million in 2021") +
...
ggsave("figure_total_deaths_per_million21.png", width=8, height=6)


# Covid-19-related Deaths Per Million in 2022
ggplot(total, 
       aes(x = democracy_vdem2019, 
           y = total_deaths_per_million22,
           weight = total_gdp2019,
           size = total_gdp2019,
           fill = democracy_vdem2019)) + 
  geom_point(alpha = 0.5, shape=21, color="black") +
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Covid-19-related Deaths Per Million in 2022") +
  xlab("Democracy Index (V-Dem) in 2019") +
  theme(legend.position = "none") + 
  geom_smooth(method = lm, color = "black")+
  coord_cartesian(ylim = c(-1000, 7000)) +
...
ggsave("figure_total_deaths_per_million22.png", width=8, height=6)
