...
panelcombine, use(${path_output}/2sls_by_decade_panel2.tex ${path_output}/2sls_by_decade_panel3.tex ${path_output}/2sls_by_decade_panel4.tex) paneltitles("Mean Bot 50\% Income Share in 1991-2000" "Mean Bot 50\% Income Share in 2001-2010" "Mean Bot 50\% Income Share in 2011-2020") columncount(13) save(${path_output}/2sls_by_decade_bot50_inc_shr.tex) cleanup
