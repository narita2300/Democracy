...
ggplot(total, 
  ...
  ylab("Effective Retirement Age Women in 1980") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Effective Retirement Age Women in 1990") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Effective Retirement Age Women in 2000") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Effective Retirement Age Women in 2010") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Effective Retirement Age Women in 2020") +
