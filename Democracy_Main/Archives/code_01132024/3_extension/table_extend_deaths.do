...
local count = 1
local outcomes total_deaths_per_million total_deaths_per_million21 total_deaths_per_million22 excess_deaths_million_who2020 excess_deaths_million_who2021
...
foreach outcome of local outcomes{
	...
	esttab using table_extend_deaths_panelA`count'.tex, ///
...
panelcombine, use(table_extend_deaths_panelA1.tex table_extend_deaths_panelA2.tex table_extend_deaths_panelA3.tex table_extend_deaths_panelA4.tex table_extend_deaths_panelA5.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table_extend_deaths_panelA.tex) cleanup
...
foreach outcome of local outcomes{
	...
	esttab using table_extend_deaths_panelB`count'.tex, ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(table_extend_deaths_panelB1.tex table_extend_deaths_panelB2.tex table_extend_deaths_panelB3.tex table_extend_deaths_panelB4.tex table_extend_deaths_panelB5.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table_extend_deaths_panelB.tex) cleanup
