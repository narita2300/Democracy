...
ggplot(total, 
  ...
  ylab("Mean Top 1% Income Share in 1991-2000") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Top 1% Income Share in 2001-2010") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Top 1% Income Share in 2011-2020") +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Top 10% Income Share in 1991-2000") +
  xlab("Democracy Index (V-Dem) in 1990") +
  theme(legend.position = "none") + 
  geom_smooth(method = lm, color = "black")+
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Top 10% Income Share in 2001-2010") +
  xlab("Democracy Index (V-Dem) in 2000") +
  theme(legend.position = "none") + 
  geom_smooth(method = lm, color = "black")+
  coord_cartesian(ylim = c(40, 90)) +
...
ggplot(total, 
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Top 10% Income Share in 2011-2020") +
  xlab("Democracy Index (V-Dem) in 2010") +
  theme(legend.position = "none") + 
  geom_smooth(method = lm, color = "black")+
  coord_cartesian(ylim = c(40, 90)) +
