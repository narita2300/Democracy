...
foreach outcome of local outcomes{
	...
	if "`outcome'" == "mean_LifeLadder_2010_2019" | "`outcome'" == "mean_Positiveaffect_2010_2019" {
	...
	esttab using table_happiness_panelA`count'.tex, ///
...
panelcombine, use(table_happiness_panelA1.tex table_happiness_panelA2.tex table_happiness_panelA3.tex table_happiness_panelA4.tex table_happiness_panelA5.tex table_happiness_panelA6.tex table_happiness_panelA7.tex table_happiness_panelA8.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table_happiness_panelA.tex) cleanup
...
foreach outcome of local outcomes{
	...
	esttab using table_happiness_panelB`count'.tex, ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(table_happiness_panelB1.tex table_happiness_panelB2.tex table_happiness_panelB3.tex table_happiness_panelB4.tex table_happiness_panelB5.tex table_happiness_panelB6.tex table_happiness_panelB7.tex table_happiness_panelB8.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table_happiness_panelB.tex) cleanup
