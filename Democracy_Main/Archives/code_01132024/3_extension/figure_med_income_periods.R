...
## (a) Mean Growth Rate Median Income in 1981-1990
ggplot(total, 
       aes(x = democracy_vdem1980, 
           y = mean_g_med_income_1981_1990,
  ...
  ylab("Mean Growth Rate Median Income in 1981-1990") +
...
ggsave("figure_mean_g_med_income_1981_1990.png", width=8, height=6)

## (b) Mean Growth Rate Median Income in 1991-2000
ggplot(total, 
       aes(x = democracy_vdem1990, 
           y = mean_g_med_income_1991_2000,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Growth Rate Median Income in 1991-2000") +
...
ggsave("figure_mean_g_med_income_1991_2000.png", width=8, height=6)

## (c) Mean Growth Rate Median Income in 2001-2010

ggplot(total, 
       aes(x = democracy_vdem2000, 
           y = mean_g_med_income_2001_2010,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Growth Rate Median Income in 2001-2010") +
...
ggsave("figure_mean_g_med_income_2001_2010.png", width=8, height=6)

## (d) Mean Growth Rate Median Income in 2011-2020
ggplot(total, 
       aes(x = democracy_vdem2010, 
           y = mean_g_med_income_2011_2020,
  ...
  theme_ipsum(axis_title_size = 20) +
  theme(legend.position="bottom") +
  ylab("Mean Growth Rate Median Income in 2011-2020") +
...
ggsave("figure_mean_g_med_income_2011_2020.png", width=8, height=6)