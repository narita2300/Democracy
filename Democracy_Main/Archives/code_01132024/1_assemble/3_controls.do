...
*** import GDP data ***
import excel "${path_input}/controls/total_gdp/imf-dm-export-20210423.xls", sheet("NGDPD") cellrange(A3:AV231) clear
...
import excel "${path_input}/controls/total_gdp/imf-dm-export-20210515-2.xls", sheet("NGDPDPC") cellrange(A3:AV231) clear
