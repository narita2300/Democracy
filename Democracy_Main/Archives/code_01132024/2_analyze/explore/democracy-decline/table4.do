...
binscatter change_ftti_2001_2019 democracy_vdem2000, ytitle("Change in protectionist trade policies") xtitle("Democracy Index (V-Dem, 2000)") savegraph(${path_dropbox}/figures/democracy_vdem2000_change_ftti_2001_2019_binned.png) replace yscale(r(-1 1))

binscatter change_seatw_illib_2001_2019 democracy_vdem2000, ytitle("Change in illiberal rhetoric by political parties") xtitle("Democracy Index (V-Dem, 2000)") savegraph(${path_dropbox}/figures/democracy_vdem2000_change_seatw_illib_2001_2019_binned.png) replace yscale(r(-1 1))

binscatter change_seatw_popul_2001_2019 democracy_vdem2000, ytitle("Change in populist rhetoric by political parties") xtitle("Democracy Index (V-Dem, 2000)") savegraph(${path_dropbox}/figures/democracy_vdem2000_change_seatw_popul_2001_2019_binned.png) replace yscale(r(-1 1))

binscatter change_v2smpolhate_2001_2019 democracy_vdem2000, ytitle("Change in hate speech by political parties") xtitle("Democracy Index (V-Dem, 2000)") savegraph(${path_dropbox}/figures/democracy_vdem2000_change_v2smpolhate_2001_2019_binned.png) replace yscale(r(-1 1))

binscatter change_v2smpolsoc_2001_2019 democracy_vdem2000, ytitle("Change in political polarization of society") xtitle("Democracy Index (V-Dem, 2000)") savegraph(${path_dropbox}/figures/democracy_vdem2000_change_v2smpolsoc_2001_2019_binned.png) replace yscale(r(-1 1))
...
forv i = 0/6{
	...
	foreach outcome of local outcomes{
		...
		if `i' == 0{
			...
			eststo: reg change_`outcome'_2001_2019 ${base_covariates2000} ${dem2000} ${weight2000}, vce(robust)
			// estadd ysumm
			...
			eststo: ivreg2 change_`outcome'_2001_2019 ${base_covariates2000} (${dem2000}=${iv`i'}) ${weight2000}, robust
		...
		if `count' == 7{
			local last `"stats(N, fmt(0) labels("N")) postfoot(`" \\ Baseline Controls & \xmark & \cmark & \xmark & \cmark & \xmark & \cmark & \xmark & \cmark & \xmark & \cmark \\"')"'
		}
		else {
