...
X_titles <- c(
  "Democracy Index (V-Dem) in 1960",
  "Democracy Index (V-Dem) in 1970",
...
Y_weighting <- c("total_gdp1960_wb",
                 "total_gdp1970_wb",
                 "total_gdp1980",
                 "total_gdp1990",
                 "total_gdp2000",
...
for (i in 1:length(X)) {
  ...
  ggsave(paste(Y[i], "_", X[i], "_notitle_noweighting.png", sep = ""), width = 8, height = 6)
}
