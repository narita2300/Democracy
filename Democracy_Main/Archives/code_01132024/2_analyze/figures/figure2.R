...
# (b2) 1st stage relationship between democracy (V-Dem) and fraction speaking European IV
ggplot(total, 
       aes(x = lpd1500s, 
           y = democracy_vdem2019,
           weight = total_gdp2019,
...
# (d): Reduced-form relationship between GDP Growth Rates in 2020 and log European settler mortality
ggplot(total, 
       aes(x = logem4, 
...
ggsave("figure2e.png", width=8, height=6)
...
ggsave("figure2f.png", width=8, height=6)
