...
panelcombine, use(table2_pc_panelA1.tex table2_pc_panelA2.tex table2_pc_panelA3.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table2_pc_panelA.tex) cleanup
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(table2_pc_panelB1.tex table2_pc_panelB2.tex table2_pc_panelB3.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table2_pc_panelB.tex) cleanup
