...
************************************ 
************************************ Y: Mean GDP Growth Rate in 1961-1970 

eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls mean_growth_rate_1961_1970 (democracy_vdem1960=${iv`i'})[w=total_gdp1960], vce(robust)
// 		eststo: ivregress 2sls mean_growth_rate_1961_1970 abs_lat mean_temp_1961_1970 mean_precip_1961_1980 median_age1980 pop_density1980 (democracy_vdem1980=${iv`i'})[w=total_gdp1980], vce(robust)
	}
	
eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls mean_growth_rate_1961_1970 gdppc1960 (democracy_vdem1960=${iv`i'}), vce(robust)
// 		eststo: ivregress 2sls mean_growth_rate_1961_1970 abs_lat mean_temp_1961_1970 mean_precip_1961_1980 median_age1980 pop_density1980 (democracy_vdem1980=${iv`i'})[w=total_gdp1980], vce(robust)
}
forv i = 1/6{
		eststo: ivregress 2sls mean_growth_rate_2001_2019 (democracy_vdem2000=${iv`i'}), vce(robust)
// 		eststo: ivregress 2sls mean_growth_rate_1961_1970 abs_lat mean_temp_1961_1970 mean_precip_1961_1980 median_age1980 pop_density1980 (democracy_vdem1980=${iv`i'})[w=total_gdp1980], vce(robust)
}
...
************************************ 
************************************ Y: Mean GDP Growth Rate in 1971-1980 
...
eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls mean_growth_rate_2011_2019 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
		eststo: ivregress 2sls mean_growth_rate_2011_2019 abs_lat mean_temp_2001_2010 mean_precip_2001_2010 median_age2010 pop_density2010 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
	}
...
eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls mean_growth_rate_2011_2019 gdppc2010 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
		eststo: ivregress 2sls mean_growth_rate_2011_2019 gdppc2010 abs_lat mean_temp_2001_2010 mean_precip_2001_2010 median_age2010 pop_density2010 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
	}
...
eststo clear 
forv i = 1/6{
		eststo: ivregress 2sls mean_growth_rate_2011_2019 total_gdp2010 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
		eststo: ivregress 2sls mean_growth_rate_2011_2019 total_gdp2010 abs_lat mean_temp_2001_2010 mean_precip_2001_2010 median_age2010 pop_density2010 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
	}
