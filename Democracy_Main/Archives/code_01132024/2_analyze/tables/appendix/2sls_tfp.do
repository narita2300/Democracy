...
esttab using 2sls_mechanisms_tfpgrowth.tex, ///
...
// }
// esttab using 2sls_mechanisms_tfp.tex, ///
// keep(${dem2000}) replace label b(a1) se(a1) stats(N, labels("N")) nogaps nonotes mlabels(none)
...
forvalues i = 1/6{
	...
	esttab using 2sls_mechanisms_tfpgrowth.tex, ///
keep(${dem2000}) append label b(a1) se(a1) stats(N, labels("N")) nogaps nonotes mlabels(none)
}
