...
mechanisms <- total[, c(
  ...
  "mean_rd_expenditure_2001_2019",
  "mean_rd_researchers_2001_2019",
  "mean_new_business_2001_2019",
  "mean_china_import_gdp", 
  "mean_china_export_gdp")]
...
output <- stargazer(mechanisms, 
                    ...
                    covariate.labels = c(
                      ...
                      "Mean Tax Revenue Share of GDP in 2001-2019",
                      "Mean Primary School Enrollment Rate in 2001-2019 (net \\%)",
                      "Mean Secondary School Enrollment Rate in 2001-2019 (net \\%)",
                      "Mean Child Mortality Rate per 1000 in 2001-2019",
                      "Mean Conflict Index in 2001-2019",
                      "Mean R\\&D Expenditure in 2001-2019 (\\% of GDP)",
                      "Mean R\\&D Researchers per Million People in 2001-2019",
                      "Mean No. of New Business Registrations per 1000 People in 2001-2019",
                      "Mean Total Value of Imports from China in 2001-2019 (\\% of GDP)",
                      "Mean Total Value of Exports to China in 2001-2019 (\\% of GDP)"
                      ),
