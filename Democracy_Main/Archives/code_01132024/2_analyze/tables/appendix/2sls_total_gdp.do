...
foreach outcome of local outcomes{
	...
	esttab using table2_total_gdp_panelA`count'.tex, ///
...
panelcombine, use(table2_total_gdp_panelA1.tex table2_total_gdp_panelA2.tex table2_total_gdp_panelA3.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table2_total_gdp_panelA.tex) cleanup
...
foreach outcome of local outcomes{
	...
	esttab using table2_total_gdp_panelB`count'.tex, ///
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(table2_total_gdp_panelB1.tex table2_total_gdp_panelB2.tex table2_total_gdp_panelB3.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(13) save(table2_total_gdp_panelB.tex) cleanup
