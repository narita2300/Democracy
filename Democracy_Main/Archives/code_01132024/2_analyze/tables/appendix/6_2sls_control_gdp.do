...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(${path_appendix}/6_2sls_control_gdp_panel1.tex ${path_appendix}/6_2sls_control_gdp_panel2.tex) paneltitles("Mean GDP Growth Rate in 2001-2019" "GDP Growth Rate in 2020") columncount(13) save(${path_appendix}/6_2sls_control_gdp_panelA.tex) cleanup
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(${path_appendix}/6_2sls_control_gdp_panel1.tex ${path_appendix}/6_2sls_control_gdp_panel2.tex) paneltitles("Mean GDP Growth Rate in 2001-2019" "GDP Growth Rate in 2020") columncount(13) save(${path_appendix}/6_2sls_control_gdp_panelB.tex) cleanup
...
include "${path_code}/2_analyze/tables/PanelCombine_simple.do"
panelcombine, use(${path_appendix}/6_2sls_control_gdp_panel1.tex ${path_appendix}/6_2sls_control_gdp_panel2.tex) paneltitles("Mean GDP Growth Rate in 2001-2019" "GDP Growth Rate in 2020") columncount(13) save(${path_appendix}/6_2sls_control_gdp_panelC.tex) cleanup
