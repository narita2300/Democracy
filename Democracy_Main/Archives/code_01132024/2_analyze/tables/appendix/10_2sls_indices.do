...
foreach var of local outcomes{
	...
	foreach i in `index'{
		...
		if "`i'" == "democracy_eiu2019" & "`var'" == "${outcome3}"{
...
panelcombine, use(${path_appendix}/10_2sls_index_panel1.tex ${path_appendix}/10_2sls_index_panel2.tex ${path_appendix}/10_2sls_index_panel3.tex ${path_appendix}/10_2sls_index_panel4.tex) paneltitles("") columncount(13) save(${path_appendix}/10_2sls_index_`var'.tex) cleanup
