...
foreach outcome of local outcomes{
	...
	esttab using ${path_dropbox}/tables/table2_panelA`count'.tex, ///
...
panelcombine, use(${path_dropbox}/tables/table2_panelA1.tex ${path_dropbox}/tables/table2_panelA2.tex ${path_dropbox}/tables/table2_panelA3.tex) paneltitles("`: var label `:word 1 of `outcomes'''" "`: var label `:word 2 of `outcomes'''" "`: var label `:word 3 of `outcomes'''") columncount(11) save(${path_dropbox}/tables/table2_panelA.tex) cleanup
