...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_1981_1990 gdppc1980 abs_lat mean_temp_1981_1990 mean_precip_1981_1990 (democracy_vdem1980=${iv`i'})[w=total_gdp1980], vce(robust)
	}
...
eststo clear 
forv i = 1/5{
		eststo: ivregress 2sls mean_growth_rate_1981_1990 gdppc1980 (democracy_vdem1980=${iv`i'}), vce(robust)
		eststo: ivregress 2sls mean_growth_rate_1981_1990 gdppc1980 abs_lat mean_temp_1981_1990 mean_precip_1981_1990 (democracy_vdem1980=${iv`i'}), vce(robust)
	}
...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_1991_2000 gdppc1990 abs_lat mean_temp_1991_2000 mean_precip_1991_2000 (democracy_vdem1990=${iv`i'})[w=total_gdp1990], vce(robust)
	}
...
eststo clear 
forv i = 1/5{
		eststo: ivregress 2sls mean_growth_rate_1991_2000 gdppc1990 (democracy_vdem1990=${iv`i'}), vce(robust)
		eststo: ivregress 2sls mean_growth_rate_1991_2000 gdppc1990 abs_lat mean_temp_1991_2000 mean_precip_1991_2000 (democracy_vdem1990=${iv`i'}), vce(robust)
	}
...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_2001_2010 gdppc2000 abs_lat mean_temp_2001_2010 mean_precip_2001_2010 (democracy_vdem2000=${iv`i'})[w=total_gdp2000], vce(robust)
	}
...
eststo clear 
forv i = 1/5{
		eststo: ivregress 2sls mean_growth_rate_2001_2010 gdppc2000 (democracy_vdem2000=${iv`i'}), vce(robust)
		eststo: ivregress 2sls mean_growth_rate_2001_2010 gdppc2000 abs_lat mean_temp_2001_2010 mean_precip_2001_2010 (democracy_vdem2000=${iv`i'}), vce(robust)
	}
...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_2011_2020 gdppc2000 abs_lat mean_temp_2011_2016 mean_precip_2011_2016 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
	}
...
eststo clear 
forv i = 1/5{
		eststo: ivregress 2sls mean_growth_rate_2011_2020 gdppc2010 (democracy_vdem2010=${iv`i'}), vce(robust)
		eststo: ivregress 2sls mean_growth_rate_2011_2020 gdppc2010 abs_lat mean_temp_2011_2016 mean_precip_2011_2016 (democracy_vdem2010=${iv`i'}), vce(robust)
	}
...
*********************************** weight by baseline GDP
************************************ Y: Mean GDP growth rate in 2020

eststo clear 
forv i = 1/5{
		eststo: ivregress 2sls gdp_growth2020 gdppc2019 (democracy_vdem2019=${iv`i'})[w=total_gdp2019], vce(robust)
		eststo: ivregress 2sls gdp_growth2020 gdppc2019 abs_lat mean_temp_2011_2016 mean_precip_2011_2016 (democracy_vdem2019=${iv`i'})[w=total_gdp2019], vce(robust)
	}
...
eststo clear 
forv i = 1/5{
		eststo: ivregress 2sls gdp_growth2020 gdppc2020 (democracy_vdem2019=${iv`i'}), vce(robust)
		eststo: ivregress 2sls gdp_growth2020 gdppc2020 abs_lat mean_temp_2011_2016 mean_precip_2011_2016 (democracy_vdem2019=${iv`i'}), vce(robust)
	}
