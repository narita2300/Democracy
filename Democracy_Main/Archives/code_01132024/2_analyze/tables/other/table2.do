...
eststo clear
forv i = 1/5{
		eststo: ivreg2 mean_gdppc_growth_2001_2019 (${dem2000}=${iv`i'})${weight2000}, robust
		scalar fstat = e(widstat)
		estadd scalar fs = fstat
		estadd scalar fs_root = fstat^(1/2)
				
		eststo: ivreg2 mean_gdppc_growth_2001_2019 ${base_covariates2000} (${dem2000}=${iv`i'})${weight2000}, robust
		scalar fstat = e(widstat)
		estadd scalar fs = fstat
		estadd scalar fs_root = fstat^(1/2)
}
