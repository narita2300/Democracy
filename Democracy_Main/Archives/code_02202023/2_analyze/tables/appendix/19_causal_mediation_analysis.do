...
eststo: ivmediate gdp_growth2020, mediator(containmenthealth10) treatment(democracy_vdem2019) instrument(logem4) vce(robust) 
eststo: ivmediate gdp_growth2020, mediator(coverage10) treatment(democracy_vdem2019) instrument(logem4) vce(robust) 
eststo: ivmediate gdp_growth2020, mediator(days_betw_10th_case_and_policy) treatment(democracy_vdem2019) instrument(logem4) vce(robust) 
