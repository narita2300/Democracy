...
panelcombine, use(${path_appendix}/18_policy_mechanisms_panel1.tex) paneltitles(" ") columncount(11) save(${path_appendix}/18_policy_mechanisms_panelA.tex) cleanup
...
include "${path_code}/2_analyze/tables/PanelCombine_simplest.do"
panelcombine, use(${path_appendix}/18_policy_mechanisms_panel2.tex) paneltitles(" ") columncount(11) save(${path_appendix}/18_policy_mechanisms_panelB.tex) cleanup
...
include "${path_code}/2_analyze/tables/PanelCombine_simplest.do"
panelcombine, use(${path_appendix}/18_policy_mechanisms_panel3.tex) paneltitles(" ") columncount(11) save(${path_appendix}/18_policy_mechanisms_panelC.tex) cleanup
