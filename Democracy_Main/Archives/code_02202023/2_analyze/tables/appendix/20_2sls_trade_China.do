...
panelcombine, use(20_2sls_china_trade_panel1.tex 20_2sls_china_trade_panel2.tex 20_2sls_china_trade_panel3.tex 20_2sls_china_trade_panel4.tex 20_2sls_china_trade_panel5.tex 20_2sls_china_trade_panel6.tex) paneltitles("A: OLS" "B: Instrument for Democracy by Settler Mortality" "C: Instrument for Democracy by Population Density in 1500s" "D: Instrument for Democracy by Legal Origin" "E: Instrument for Democracy by Language" "F: Instrument for Democracy by Crops and Minerals") columncount(5) save(20_2sls_china_trade.tex) cleanup
