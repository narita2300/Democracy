...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_1981_1990 abs_lat mean_temp_1981_1990 mean_precip_1981_1990 (democracy_vdem1980=${iv`i'})[w=total_gdp1980], vce(robust)
	}
...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_1991_2000 abs_lat mean_temp_1991_2000 mean_precip_1991_2000 (democracy_vdem1990=${iv`i'})[w=total_gdp1990], vce(robust)
	}
...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_2001_2010 abs_lat mean_temp_2001_2010 mean_precip_2001_2010 (democracy_vdem2000=${iv`i'})[w=total_gdp2000], vce(robust)
	}
...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_2011_2020 abs_lat mean_temp_2011_2016 mean_precip_2011_2016 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
	}
...
esttab using ./output/tables/2sls_by_decade_panelB.tex, ///
keep(democracy_vdem1980) ///
replace label b(a1) se(a1) stats(N, labels("N")) nodepvars nogaps nonotes mlabels(none) ///
title(`"Democracy's Effect on Mean GDP Growth Rates by decade"') ///
posthead(`" & \multicolumn{10}{c}{ Dependent Variable is Mean GDP Growth Rate in 1981-1990} \\ \cline{2-11}  \\[-1.8ex]"') ///
...
forv i = 1/5{
		...
		eststo: ivregress 2sls mean_growth_rate_2011_2020 gdppc2010 abs_lat mean_temp_2011_2016 mean_precip_2011_2016 (democracy_vdem2010=${iv`i'})[w=total_gdp2010], vce(robust)
	}
