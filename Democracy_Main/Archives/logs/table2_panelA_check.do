...
// column 1
ivreg2 mean_growth_rate_2001_2019 (democracy_vdem2000=logem4) [w=total_gdp2000], robust first

// column 2
ivreg2 mean_growth_rate_2001_2019 ${base_covariates2000} (democracy_vdem2000=logem4) [w=total_gdp2000], robust first

// column 3
ivreg2 mean_growth_rate_2001_2019 (democracy_vdem2000=lpd1500s) [w=total_gdp2000], robust first

// column 4
ivreg2 mean_growth_rate_2001_2019 ${base_covariates2000} (democracy_vdem2000=lpd1500s) [w=total_gdp2000], robust first

// column 5
ivreg2 mean_growth_rate_2001_2019 (democracy_vdem2000=legor_uk) [w=total_gdp2000], robust first

// column 6
ivreg2 mean_growth_rate_2001_2019 ${base_covariates2000} (democracy_vdem2000=legor_uk) [w=total_gdp2000], robust first

// column 7
ivreg2 mean_growth_rate_2001_2019 (democracy_vdem2000=EngFrac EurFrac) [w=total_gdp2000], robust first

// column 8
ivreg2 mean_growth_rate_2001_2019 ${base_covariates2000} (democracy_vdem2000=EngFrac EurFrac) [w=total_gdp2000], robust first

// column 9
ivreg2 mean_growth_rate_2001_2019 (democracy_vdem2000=bananas coffee copper maize millet rice rubber silver sugarcane wheat) [w=total_gdp2000], robust first

// column 10 
ivreg2 mean_growth_rate_2001_2019 ${base_covariates2000} (democracy_vdem2000=bananas coffee copper maize millet rice rubber silver sugarcane wheat) [w=total_gdp2000], robust first

// column 11
ivreg2 mean_growth_rate_2001_2019 (democracy_vdem2000=logem4 lpd1500s legor_uk EngFrac EurFrac bananas coffee copper maize millet rice rubber silver sugarcane wheat) [w=total_gdp2000], robust first

// column 12
ivreg2 mean_growth_rate_2001_2019 ${base_covariates2000} (democracy_vdem2000=logem4 lpd1500s legor_uk EngFrac EurFrac bananas coffee copper maize millet rice rubber silver sugarcane wheat) [w=total_gdp2000], robust first
