...
graph export gdppc_coef_plot_gdppc_control.png, as(png) name("Graph") replace
...
graph export gdppc_21st_coef_plot_gdppc_control.png, as(png) name("Graph") replace
...
graph export deaths_coef_plot_gdppc_control.png, as(png) name("Graph") replace
...
(m6, keep(${dem2019}) rename(${dem2019} = "All IVs") mcolor(edkblue) ciopts(lcolor(edkblue)) mlabcolor(edkblue) mlabposition(12) ) ///
(r6,  keep(${dem2019}) rename(${dem2019} = "All IVs") offset(-0.2)  mlabposition(7)   mcolor(gs10) ciopts(lcolor(gs10)) mlabcolor(gs10)) ///
, xline(0) graphregion(color(white)) mlabel format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") xscale(range(-5 5)) xlabel(-5(1)5) title("Effect of 1 s.d. democracy increase on economic growth in 2020", span ) subtitle("Add baseline GDP per capita control", span margin(b=5)) legend(order(2 "2SLS" 4 "OLS" 1 "95% CI"))
...
graph export ${path_presentation}/gdppc_21st_coef_plot_gdppc_control.png, as(png) name("Graph") replace
...
graph export ${path_presentation}/deaths_coef_plot_gdppc_control.png, as(png) name("Graph") replace
