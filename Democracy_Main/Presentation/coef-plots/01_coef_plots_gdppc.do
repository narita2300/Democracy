...
, xline(0) graphregion(color(white)) mlabel format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") xscale(range(-5 5)) xlabel(-5(1)5) title("Effect of 1 s.d. democracy increase on economic growth in 2020", span size(medium)) subtitle("Base specification, no controls", span margin(b=5)) legend(order(2 "2SLS" 4 "OLS" 1 "95% CI"))

graph export gdppc_coef_plot_hastitle.png, as(png) name("Graph") replace


**************************** GDP PER CAPITA GROWTH IN 2001-2019 *******************************

local var mean_gdppc_growth_2001_2019
eststo clear
forv i = 1/6{
	if `i' == 6{
...
graph export gdppc_21st_coef_plot_hastitle.png, as(png) name("Graph") replace
