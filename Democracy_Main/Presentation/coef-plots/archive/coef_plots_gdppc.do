...
, xline(0) legend(off) graphregion(color(white)) mlabel mlabposition(12) mlabcolor(edkblue) format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") xscale(range(-5 5)) xlabel(-5(1)5) title("Effect of 1 s.d. democracy increase on economic growth in 2020", span)

graph export ${path_presentation}/gdppc_coef_plot.png, as(png) name("Graph") replace
...
(m4, keep(${dem2019}) rename(${dem2019} = "Language IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
(m5, keep(${dem2019}) rename(${dem2019} = "Crops & Minerals IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
, xline(0) legend(off) graphregion(color(white)) mlabel mlabposition(12) mlabcolor(edkblue) format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") xscale(range(-5 5)) xlabel(-5(1)5) title("Effect of 1 s.d. democracy increase on economic growth in 2020", span ) subtitle("Base specification, no controls", span margin(b=5))
...
(m4, keep(${dem2019}) rename(${dem2019} = "Language IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
(m5, keep(${dem2019}) rename(${dem2019} = "Crops & Minerals IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
, xline(0) legend(off) graphregion(color(white)) mlabel mlabposition(12) mlabcolor(edkblue) format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") xscale(range(-5 5)) xlabel(-5(1)5) title("Effect of 1 s.d. democracy increase on economic growth in 2020", span) subtitle("Base specification, add baseline controls", span margin(b=5))

graph export ${path_presentation}/gdppc_coef_plot_controls.png, as(png) name("Graph") replace
...
graph export ${path_presentation}/gdppc_coef_plot_gdppc_control.png, as(png) name("Graph") replace
...
graph export ${path_presentation}/gdppc_coef_plot_total_gdp_control.png, as(png) name("Graph") replace 
...
graph export ${path_presentation}/gdppc_coef_plot_csp_index.png, as(png) name("Graph") replace
...
graph export ${path_presentation}/gdppc_coef_plot_eiu_index.png, as(png) name("Graph") replace
...
graph export ${path_presentation}/gdppc_coef_plot_fh_index.png, as(png) name("Graph") replace
...
(m4, keep(${dem2019}) rename(${dem2019} = "Language IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
(m5, keep(${dem2019}) rename(${dem2019} = "Crops & Minerals IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
, xline(0) legend(off) graphregion(color(white)) mlabel mlabposition(12) mlabcolor(edkblue) format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") title("Effect of 1 s.d. democracy increase on economic growth in 2020", span)

graph export ${path_presentation}/gdppc_coef_plot_no_weighting.png, as(png) name("Graph") replace
...
(m5, keep(${dem2019}) rename(${dem2019} = "Crops & Minerals IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
, xline(0) legend(off) graphregion(color(white)) mlabel mlabposition(12) mlabcolor(edkblue) format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") title("Effect of 1 s.d. democracy increase on economic growth in 2020", span)
graph export ${path_presentation}/gdppc_coef_plot_pop_weighting.png, as(png) name("Graph") replace
...
graph export ${path_presentation}/gdppc_coef_plot_remove_g7.png, as(png) name("Graph") replace
...
, xline(0) legend(off) graphregion(color(white)) mlabel mlabposition(12) mlabcolor(edkblue) format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") xscale(range(-5 5)) xlabel(-5(1)5) title("Effect of 1 s.d. democracy increase on economic growth in 2020", span)
// (m3, keep(${dem2019}) rename(${dem2019} = "Legal Origin IV") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
graph export ${path_presentation}/gdppc_coef_plot_removeUSChina.png, as(png) name("Graph") replace
...
graph export ${path_presentation}/gdppc_coef_plot_remove_outliers.png, as(png) name("Graph") replace
...
, xline(0) legend(off) graphregion(color(white)) mlabel mlabposition(12) mlabcolor(edkblue) format(%9.2g) xtitle("Democracy's Effect on Mean GDP Per Capita Growth Rate in 2001-2019") xscale(range(-5 5)) xlabel(-5(1)5)
...
(m4, keep(${dem2019}) rename(${dem2019} = "Language IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
(m5, keep(${dem2019}) rename(${dem2019} = "Crops & Minerals IVs") mcolor(edkblue) ciopts(lcolor(edkblue))) ///
, xline(0) legend(off) graphregion(color(white)) mlabel mlabposition(12) mlabcolor(edkblue) format(%9.2g) xtitle("GDP Per Capita Growth Rate in 2020") 
