...
gen newcl=wbcode2
tsset newcl year
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS depvar (dem L1.y L2.y L3.y L4.y L1.depvar L2.depvar L3.depvar L4.depvar) (depvar demreg) (y) (yy*), ydeep(1960) ystart(1964) yfinal(2019) truncate(4)
...
#delimit ;
estout eOLS1 eOLS2 eOLS3 eOLS4 eOLS5 eOLS6 eOLS7 eOLS8 eOLS9   using ${project}/replication_files_ddcg/results/TableChannelsTop.tex, style(tex) 
...
#delimit ;
estout eOLS1_add eOLS2_add eOLS3_add eOLS4_add eOLS5_add eOLS6_add eOLS7_add eOLS8_add eOLS9_add  using ${project}/replication_files_ddcg/results/TableChannelsTop_Add.tex, style(tex) 
...
#delimit ;
estout eIV1 eIV2 eIV3 eIV4 eIV5 eIV6 eIV7 eIV8 eIV9   using ${project}/replication_files_ddcg/results/TableChannelsMid.tex, style(tex) 
varlabels(dem "Democracy" ) 
cells(b(star fmt(%9.3f)) se(par)) 
...
#delimit ;
estout eIV1_add eIV2_add eIV3_add eIV4_add eIV5_add eIV6_add eIV7_add eIV8_add eIV9_add  using ${project}/replication_files_ddcg/results/TableChannelsMid_Add.tex, style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of outcome process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
...
#delimit ;
estout eIVb1 eIVb2 eIVb3 eIVb4 eIVb5 eIVb6 eIVb7 eIVb8 eIVb9   using ${project}/replication_files_ddcg/results/TableChannelsBot.tex, style(tex) 
varlabels(dem "Democracy" ) 
cells(b(star fmt(%9.3f)) se(par)) 
...
#delimit ;
estout eIVb1_add eIVb2_add eIVb3_add eIVb4_add eIVb5_add eIVb6_add eIVb7_add eIVb8_add eIVb9_add  using ${project}/replication_files_ddcg/results/TableChannelsBot_Add.tex, style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of outcome process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
