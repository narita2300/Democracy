...
vareffects1
parmest, format(estimate min95 max95) saving(${project}/replication_files_ddcg/results/impulse_var1, replace)
use ${project}/replication_files_ddcg/results/impulse_var1, clear
split parm, p("effect")
keep if parm2!=""
...
twoway (tsline estimate, lcolor(black) lpattern(solid)) ///
	   ...
	   xlabel(0(5)30)
graph export ${project}/replication_files_ddcg/results/ImpVar1.eps, as(eps) preview(off) replace /*Plots and saves figure 1*/
