...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y) (y dem) () (yy*), ydeep($START_YEAR) ystart($START_YEAR+1) yfinal($END_YEAR-1) truncate(4)
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y) (y dem) () (yy*), ydeep($START_YEAR) ystart($START_YEAR+2) yfinal($END_YEAR-1) truncate(4)
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y L5.y L6.y L7.y L8.y) (y dem) () (yy*), ydeep($START_YEAR) ystart($START_YEAR+8) yfinal($END_YEAR-1) truncate(4)
