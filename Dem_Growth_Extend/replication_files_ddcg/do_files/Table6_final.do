...
// use ${project}/replication_files_ddcg/DDCGdata_final.dta
use ${project}/data/extended.dta
keep if (year >= $START_YEAR) & (year <= $END_YEAR)
gen instrument=demreg

*Creation of spatial lags*
forvalues j=$START_YEAR(1)$END_YEAR{
preserve
keep if year==`j'
...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7 e8 e9  using ${project}/replication_files_ddcg/results/Table2SLSTop.tex, style(tex) 
...
#delimit ;
estout e1_add e2_add e3_add e4_add e5_add e6_add e7_add e8_add e9_add using ${project}/replication_files_ddcg/results/Table2SLSTop_Add.tex, style(tex) 
...
#delimit ;
estout e1fs e2fs e3fs e4fs e5fs e6fs e7fs e8fs e9fs using ${project}/replication_files_ddcg/results/TableFS.tex, style(tex) 
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y) (y) (demreg) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(1) 
estimates store e1
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e1_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y) (y) (demreg) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e2
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e2_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y) (y) (demreg) (yy* interfull*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e3
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e3_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y) (y) (demreg) (yy* sov1 sov2 sov3 sov4), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e4
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e4_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y) (y) (demreg) (rtrend2 rtrend3 rtrend4 rtrend5 rtrend6 rtrend7 yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e5
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e5_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y yreg tradewbreg) (y) (demreg yreg tradewbreg) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e6
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e6_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y yreg tradewbreg unrestreg) (y) (demreg yreg tradewbreg unrestreg) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e7
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e7_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y y_w) (y) (demreg y_w) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e8
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e8_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y y_w L1.y_w L2.y_w  L3.y_w  L4.y_w dem_w) (y) (demreg y_w dem_w) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e9
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e9_add
...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7 e8 e9 using ${project}/replication_files_ddcg/results/Table2SLSbot.tex, style(tex) 
varlabels(dem " Democracy" ) 
...
#delimit ;
estout e1_add e2_add e3_add e4_add e5_add e6_add e7_add e8_add e9_add using ${project}/replication_files_ddcg/results/Table2SLSBot_Add.tex, style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of GDP process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
