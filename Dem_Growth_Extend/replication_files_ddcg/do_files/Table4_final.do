...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7 e8 using "${project}/replication_files_ddcg/results/TableControlsTop.tex", style(tex) 
...
#delimit ;
estout e1_add e2_add e3_add e4_add e5_add e6_add e7_add e8_add using ${project}/replication_files_ddcg/results/TableControlsTop_Add.tex, style(tex) 
...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7 e8 using "${project}/replication_files_ddcg/results/TableControlsMid.tex", style(tex) 
varlabels(dem "Democracy") 
cells(b(star fmt(%9.3f)) se(par)) 
...
#delimit ;
estout e1_add e2_add e3_add e4_add e5_add e6_add e7_add e8_add using ${project}/replication_files_ddcg/results/TableControlsMid_Add.tex, style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of GDP process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y) (y dem) () (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e1
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e1_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y) (y dem) ()  (yy* interfull*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e2
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e2_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y) (y dem) ()  (yy* sov1 sov2 sov3 sov4), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e3
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e3_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (dem L1.y L2.y L3.y L4.y L1.unrest L2.unrest L3.unrest L4.unrest) (y dem) (unrest) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e4
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e4_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl): hhkBS y (dem L1.y L2.y L3.y L4.y L1.tradewb L2.tradewb L3.tradewb L4.tradewb) (y dem) (tradewb) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e5
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e5_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl): hhkBS y (dem L1.y L2.y L3.y L4.y L1.nfagdp L2.nfagdp L3.nfagdp L4.nfagdp) (y dem) (nfagdp) (yy*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e6
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e6_add
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl): hhkBS y (dem L1.y L2.y L3.y L4.y) (y dem) () (yy* regdum*), ydeep($START_YEAR) ystart($START_YEAR+4) yfinal($END_YEAR-1) truncate(4)
estimates store e8
nlcom (shortrun: _b[dem])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e8_add
...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7 e8 using "${project}/replication_files_ddcg/results/TableControlsBot.tex", style(tex) 
varlabels(dem "Democracy") 
...
#delimit ;
estout e1_add e2_add e3_add e4_add e5_add e6_add e7_add  e8_add using ${project}/replication_files_ddcg/results/TableControlsBot_Add.tex, style(tex) 
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years"  persistence "Persistence of GDP process") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(longrun effect$limit persistence) 
order(longrun effect$limit persistence)
