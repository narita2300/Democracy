...
graph export ${project}/replication_files_ddcg/results/FigureFS.eps, as(eps) preview(off) replace
...
// use ${project}/replication_files_ddcg/DDCGdata_final.dta, clear
use ${project}/data/extended.dta, clear
keep if (year >= $START_YEAR) & (year <= $END_YEAR)
...
graph export ${project}/replication_files_ddcg/results/FigureFSRev.eps, as(eps) preview(off) replace
