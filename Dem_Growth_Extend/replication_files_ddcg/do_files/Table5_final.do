...
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7  using ${project}/replication_files_ddcg/results/TableNonPar_RA_alt.tex, style(tex) 
...
/* Export table with results to latex */
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7  using ${project}/replication_files_ddcg/results/TableNonPar_IPW_alt.tex, style(tex) 
varlabels(effect0 "Average effect of democracy on log GDP") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(effect0) 
order(effect0)
...
/* Export table with results to latex */
#delimit ;
estout e1 e2 e3 e4 e5 e6 e7  using ${project}/replication_files_ddcg/results/TableNonPar_IPWRA_alt.tex, style(tex) 
varlabels(effect0 "Average effect of democracy on log GDP") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(effect0) 
order(effect0)
