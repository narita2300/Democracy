...
parmest, format(estimate min95 max95) saving(${project}/replication_files_ddcg/results/impulse_ra_alt, replace)
...
#delimit ;
estout e1 e2 e3 e4 using ${project}/replication_files_ddcg/results/TableNonPar_RA_alt_SHORT.tex, style(tex) 
...
parmest, format(estimate min95 max95) saving(${project}/replication_files_ddcg/results/impulse_ipw_alt, replace)
...
/* Export table with results to latex */
#delimit ;
estout e1 e2 e3 e4 using ${project}/replication_files_ddcg/results/TableNonPar_IPW_alt_SHORT.tex, style(tex) 
varlabels(effect0 "Average effect of democracy on log GDP") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(effect0) 
order(effect0)
...
parmest, format(estimate min95 max95) saving(${project}/replication_files_ddcg/results/impulse_ipwra_alt, replace)
...
/* Export table with results to latex */
#delimit ;
estout e1 e2 e3 e4 using ${project}/replication_files_ddcg/results/TableNonPar_IPWRA_alt_SHORT.tex, style(tex) 
varlabels(effect0 "Average effect of democracy on log GDP") 
cells(b(star fmt(%9.3f)) se(par)) 
keep(effect0) 
order(effect0)
