...
replace y=dy
file open myfile using ${project}/replication_files_ddcg/results/TableGRates_lags.tex, write replace /*p-value for lags 5 to 8 not reported in the table*/
...
#delimit ;
estout e1 e2 e3 e4 e1gmm e2gmm e3gmm e4gmm e1md e2md e3md e4md  using ${project}/replication_files_ddcg/results/TableGRates.tex, style(tex) 
...
#delimit ;
estout e1_add e2_add e3_add e4_add e1gmm_add e2gmm_add e3gmm_add e4gmm_add e1md_add e2md_add e3md_add e4md_add  using ${project}/replication_files_ddcg/results/TableGRates_Add.tex, style(tex) 
